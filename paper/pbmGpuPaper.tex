...
%\documentclass[final,10pt,authoryear,twocolumn]{elsarticle}
...
\caption{CPU timing plot with MPI}
...
\caption{Speedup compared to serial simulations}
...
complete before the threads were assigned the remnant of calculations.
...
\begin{figure}[H]
     ...
     \begin{subfigure}[b]{0.48\linewidth}
         ...
         \caption{Time taken to complete simulation}
         \label{fig:res_serverTimes}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.48\linewidth}
         \includegraphics[scale=0.7,trim=120 240 120 240,width=\linewidth]{soe_gpuSpeedup.pdf}
         \caption{Speedup achieved over serial simulation}
         \label{fig:res_serverSpeedup}
     \end{subfigure}
        \caption{Case-I (Ibuprofen as API) GSD at 7 min w.m.t}
